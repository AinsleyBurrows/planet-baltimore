    ...
    <div className="space-y-6">
      ...
      <div className="relative rounded-2xl overflow-hidden p-8 sm:p-12 bg-transparent border-2" style={{ borderColor: '#d4580a' }}>
        <div className="relative z-10">
          <h1 className="text-3xl sm:text-4xl font-bold mb-2" style={{ color: '#d4580a' }}>Neighborhoods</h1>
          <p className="text-muted-foreground text-sm sm:text-base">Explore Baltimore's communities — click a pin to discover what's happening nearby.</p>
        </div>
