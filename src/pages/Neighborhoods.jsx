    ...
    <div className="space-y-6">
      ...
      <div className="relative rounded-2xl overflow-hidden p-8 sm:p-12" style={{ backgroundColor: '#d4580a' }}>
        <div className="relative z-10">
          <h1 className="text-3xl sm:text-4xl font-bold mb-2 text-white">Neighborhoods</h1>
          <p className="text-white/80 text-sm sm:text-base">Explore Baltimore's communities — click a pin to discover what's happening nearby.</p>
        </div>
