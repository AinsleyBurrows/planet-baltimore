...
export default function OrganizerStudio() {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* ── Hero Header ─────────────────────────────────────────── */}
      <div className="relative rounded-3xl px-6 py-8 overflow-hidden" style={{ backgroundColor: '#d4580a' }}>
        <div className="relative flex items-start justify-between gap-4">
          <div>
            <div className="flex items-center gap-3 mb-2">
              ...
              <span className="text-xs font-semibold uppercase tracking-widest text-white/70">Planet Baltimore</span>
            </div>
            <h1 className="text-3xl sm:text-4xl font-bold tracking-tight text-white">Organizer Studio</h1>
            <p className="text-sm text-white/80 mt-1">Manage events, tickets, promoters &amp; payouts</p>
          </div>
        </div>
