    ...
    <div className="space-y-6">
      ...
      <div className="relative rounded-2xl overflow-hidden p-8 sm:p-12" style={{ backgroundColor: '#d4580a' }}>
        <div className="relative z-10 flex items-start justify-between">
          <div>
            <h1 className="text-3xl sm:text-4xl font-bold mb-2 text-white">Groups / Communities</h1>
            <p className="text-white/80 text-sm sm:text-base">Find your people and build something together in Baltimore.</p>
          </div>
          <Link to="/create-community" className="flex-shrink-0 ml-4">
            <Button className="bg-accent hover:bg-accent/90 text-accent-foreground gap-2 rounded-lg">
              ...
              <span className="hidden sm:inline">Create Group/Community Page</span>
            </Button>
          </Link>
        </div>
