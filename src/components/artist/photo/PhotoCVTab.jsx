...
import {
  GraduationCap, Images, Layers, BookOpen, Briefcase, Trophy, Radio, Newspaper,
...
const SECTIONS = [
  ...
  { key: 'solo_exhibitions', label: 'Solo Exhibitions', icon: Images, fields: ['year', 'title', 'venue', 'location'], primary: 'title', secondary: ['venue', 'location'] },
  { key: 'group_exhibitions', label: 'Group Exhibitions', icon: Layers, fields: ['year', 'title', 'venue', 'location'], primary: 'title', secondary: ['venue', 'location'] },
  { key: 'publications', label: 'Publications', icon: BookOpen, fields: ['year', 'title', 'publisher'], primary: 'title', secondary: ['publisher'] },
  { key: 'commissions', label: 'Commissions & Assignments', icon: Briefcase, fields: ['year', 'title', 'client'], primary: 'title', secondary: ['client'] },
  { key: 'awards', label: 'Awards & Grants', icon: Trophy, fields: ['year', 'title', 'organization'], primary: 'title', secondary: ['organization'] },
...
const FIELD_PLACEHOLDERS = {
  ...
  institution: 'MICA, RISD, SVA…',
  title: 'Exhibition / Series title',
  venue: 'Gallery / Museum',
  location: 'City, Country',
  publisher: 'Aperture, Steidl…',
  client: 'Client / Publication',
  organization: 'Guggenheim, Magnum…',
  program: 'Residency / Fellowship',
  publication: 'NYT, Aperture…',
  url: 'https://…'
};
...
const EMPTY = {
  artist_statement: '',
  education: [], solo_exhibitions: [], group_exhibitions: [], publications: [],
  commissions: [], awards: [], residencies: [], press: []
};

export default function PhotoCVTab({ artistId, isOwner, ownerId }) {
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h2 className="font-bold text-foreground">Photographer CV / Bio</h2>
      ...
      <div className="bg-card border border-border rounded-xl p-4">
        ...
        {editing ? (
          <textarea className="w-full px-3 py-2 rounded-lg border border-input bg-transparent text-sm resize-none focus:outline-none focus:ring-1 focus:ring-ring min-h-[120px]"
            placeholder="Write your artist statement / approach to photography…"
