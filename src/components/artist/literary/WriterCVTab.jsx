...
import {
  GraduationCap, BookOpen, Briefcase, Calendar, Trophy, Radio, Newspaper, Pencil,
...
const SECTIONS = [
  ...
  { key: 'design_experience', label: 'Editorial & Teaching Positions', icon: Briefcase, fields: ['year', 'role', 'company', 'location'], primary: 'role', secondary: ['company', 'location'] },
  { key: 'touring', label: 'Readings & Appearances', icon: Calendar, fields: ['year', 'title', 'venue', 'location'], primary: 'title', secondary: ['venue', 'location'] },
  ...
  { key: 'commissions', label: 'Commissions & Freelance', icon: Pencil, fields: ['year', 'title', 'client'], primary: 'title', secondary: ['client'] },
];

const FIELD_PLACEHOLDERS = {
  year: 'Year',
  degree: 'MFA Creative Writing',
  institution: 'Johns Hopkins, Iowa…',
  title: 'Book / Essay / Reading',
  publisher: 'Publisher / Journal',
  role: 'Editor, Professor…',
  company: 'Press / University',
  location: 'City, State',
  venue: 'Venue / Festival',
  organization: 'NEA, PEN…',
  program: 'Residency / Fellowship',
  publication: 'NYT, Paris Review…',
...
const EMPTY = {
  artist_statement: '',
  education: [], publications: [], design_experience: [], touring: [],
  awards: [], residencies: [], press: [], commissions: []
};

export default function WriterCVTab({ artistId, isOwner, ownerId }) {
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h2 className="font-bold text-foreground">Writer CV / Bio</h2>
      ...
      <div className="bg-card border border-border rounded-xl p-4">
        <p className="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-2">Author Statement</p>
        {editing ? (
          <textarea className="w-full px-3 py-2 rounded-lg border border-input bg-transparent text-sm resize-none focus:outline-none focus:ring-1 focus:ring-ring min-h-[120px]"
            placeholder="Write your author statement / literary ethos…"
